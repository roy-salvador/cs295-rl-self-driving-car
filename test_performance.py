'''
    ...
    See EXPERIMENTS variable below 
'''
...
import envs.AirSimSimplifiedActionLnMlpEnv
...
EXPERIMENTS = [
    ...
    {'title' : 'SAC_SimplifiedAction_LnMlp', 'algo': SAC, 'env' : envs.AirSimSimplifiedActionLnMlpEnv, 'model' : 'sac_lnmlp_target_normal_52'},
]
TEST_EPISODES = 100
