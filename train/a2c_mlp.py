...
def set_env(option):
	if option == 'full':
		import envs.AirSimFullActionMlpEnv as AirSimEnv
	else:
...
if __name__ == '__main__':
	...
	parser.add_argument('--log-dir', type=str, action='store', 
						dest='log_dir',default='a2c_run_mlpPolicy_10k',
	...
	if args.airsim_env == 'full':
		...
		import envs.AirSimPartialActionMlpEnv  as AirSimEnv
	elif args.airsim_env == 'full_rew1':
		import envs.AirSimFullActionMlpRew1Env as AirSimEnv
	elif args.airsim_env == 'partial_rew1':
		import envs.AirSimPartialActionMlpRew1Env as AirSimEnv
	else:
		print('No Env')
