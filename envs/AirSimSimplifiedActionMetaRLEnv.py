'''
    ...
    for Meta RL (previous action and rewards set as input to the network
'''
...
class  AirSimEnv(Env) :
    ...
    def __init__(self, 
        ...
        low = [-1,-1, -100, -1, -1, -1, -1, 0]
        high = [1,1, 100, 1, 1, 1, 1, 1]
    ...
    def get_reward_status(self) :
        ...
        # Speed
        if abs(self.current_state[7]) < (1.0/MAX_SPEED) :
            reward += -1
    ...
    def step(self, action):
        ...
        print("Timesteps left: " + str(self.time_steps_left) + ", Speed : "  + str( round(self.current_state[7]*MAX_SPEED,2) ) + 
